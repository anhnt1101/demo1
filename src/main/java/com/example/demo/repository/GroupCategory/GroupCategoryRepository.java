...
public interface GroupCategoryRepository extends JpaRepository<GroupCategory, Long>, JpaSpecificationExecutor<GroupCategory> {
    ...
    @Query("""
            ...
            """)
    boolean existsDuplicate(@Param("id") Long id, @Param("paramValue") String paramValue, @Param("paramType") String paramType, @Param("effectiveDate") Date effectiveDate, @Param("endEffectiveDate") Date endEffectiveDate);
